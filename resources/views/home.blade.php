                    ...
                    <ul class="list-inline widget-list-inline">
                        @foreach($tags as $tag)
                            <li class="list-inline-item">
                                <a href="{{ route('tag', ['id' => $tag->id, 'slug' => $tag->slug]) }}">{{ $tag->name }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
    ...
    <section class="section pb-0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5">
                    <h2 class="h5 section-title">BÀI ĐĂNG XU HƯỚNG</h2>
                    ...
                    @foreach($articlesTrending as $item)
                        <article class="card mb-4">
                            <div class="card-body d-flex">
                                ...
                                <div class="ml-3">
                                    <h4><a href="{{route('detail', $item->slug)}}" class="post-title">{{$item->title}}</a></h4>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8  mb-5 mb-lg-0">
                    <h2 class="h5 section-title">BÀI ĐĂNG GẦN ĐÂY
                    </h2>
